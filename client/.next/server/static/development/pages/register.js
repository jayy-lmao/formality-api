...
/* harmony import */ var _utils_getGraphQLUserRegisterError__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/getGraphQLUserRegisterError */ "./utils/getGraphQLUserRegisterError.ts");
...
/* harmony import */ var _styles_userDetailsCard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../styles/userDetailsCard */ "./styles/userDetailsCard.tsx");
/* harmony import */ var _styles_buttonStyle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../styles/buttonStyle */ "./styles/buttonStyle.tsx");
...
const REGISTER_USER = apollo_boost__WEBPACK_IMPORTED_MODULE_3__["gql"]`
...
const Register = () => {
  const [registerUser, {
    data
  }] = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_4__["useMutation"])(REGISTER_USER);
  const formik = Object(formik__WEBPACK_IMPORTED_MODULE_2__["useFormik"])({
    ...
    onSubmit: ({
      ...
      registerUser({
        ...
        setErrors(Object(_utils_getGraphQLUserRegisterError__WEBPACK_IMPORTED_MODULE_5__["getGraphQLUserRegisterError"])(responseErrors));
      });
    }
  });
  return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_1__["jsx"])("div", {
    css: _styles_userDetailsCard__WEBPACK_IMPORTED_MODULE_8__["userDetailsCard"],
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
    },
    ...
    __self: undefined
  }, "Register"), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_1__["jsx"])("form", {
    ...
    __self: undefined
  }, Object(_emotion_core__WEBPACK_IMPORTED_MODULE_1__["jsx"])(_components_Input__WEBPACK_IMPORTED_MODULE_7__["default"], {
    label: "Email",
    name: "email",
    id: "email",
    type: "email",
    ...
    css: _styles_buttonStyle__WEBPACK_IMPORTED_MODULE_9__["buttonStyle"],
    type: "submit",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
...
/***/ "./utils/getGraphQLUserRegisterError.ts":
/*!**********************************************!*\
  !*** ./utils/getGraphQLUserRegisterError.ts ***!
  \**********************************************/
/*! exports provided: getGraphQLUserRegisterError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGraphQLUserRegisterError", function() { return getGraphQLUserRegisterError; });
/* harmony import */ var _getValidationError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getValidationError */ "./utils/getValidationError.ts");

/* Break this into a signin error which then calls the validation error which can be used elsewhere*/

const getGraphQLUserRegisterError = errorResponse => {
  ...
  return Object(_getValidationError__WEBPACK_IMPORTED_MODULE_0__["getValidationError"])(errorResponse);
};

/***/ }),

/***/ "./utils/getValidationError.ts":
/*!*************************************!*\
  !*** ./utils/getValidationError.ts ***!
  \*************************************/
/*! exports provided: getValidationError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getValidationError = errorResponse => {
  const error = {};
  const firstGraphQLError = errorResponse && errorResponse.graphQLErrors && errorResponse.graphQLErrors[0];
  const {
    validationErrors
  } = firstGraphQLError && firstGraphQLError.extensions && firstGraphQLError.extensions.exception;

  if (validationErrors) {
    validationErrors.forEach(validationError => {
      console.log(validationError);
      error[validationError.property] = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(validationError)[0];
    });
    return error;
  }
};
